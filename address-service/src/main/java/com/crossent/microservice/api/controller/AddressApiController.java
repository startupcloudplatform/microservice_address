...
public class AddressApiController {
    ...
    @ApiImplicitParams({
            @ApiImplicitParam(name = "currentPage",  value = "page number", dataType = "int",    paramType = "query", defaultValue = "1"),
            @ApiImplicitParam(name = "countPerPage", value = "page size",   dataType = "int",    paramType = "query", defaultValue = "15"),
            @ApiImplicitParam(name = "keyword",      value = "키워드",        required = true, dataType = "string", paramType = "query")
    })
    ...
    @ApiOperation(value = "키워드 및 우편번호를 통한 목록 조회 API : ALL")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "currentPage", value = "page number", dataType = "int",    paramType = "query", defaultValue = "1"),
            @ApiImplicitParam(name = "countPerPage", value = "page size",  dataType = "int",    paramType = "query", defaultValue = "15"),
            @ApiImplicitParam(name = "keyword",     value = "키워드",        required = true, dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "zipNo",       value = "우편번호",       required = true, dataType = "long",   paramType = "query")
    })
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "countPerPage", value = "page size",  dataType = "int",  paramType = "query", defaultValue = "15"),
            @ApiImplicitParam(name = "keyword",     value = "키워드",        required = true,   dataType = "string", paramType = "query"),
            @ApiImplicitParam(name = "admCode",     value = "행정구역코드",    required = true,   dataType = "long",   paramType = "query")
    })
